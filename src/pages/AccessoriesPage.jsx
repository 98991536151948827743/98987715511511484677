...
import { motion, useScroll, useTransform } from 'framer-motion'; // Make sure to import useTransform

// --- CircularProgressBar Component (defined outside AccessoriesPage) ---
...
export default function AccessoriesPage() {
  ...
  const accessories = [
    ...
    // const { scrollYProgress } = useScroll(); // Removed this line, as CircularProgressBar handles its own scroll progress

  return (
    <div className="py-12">
      {/* Render the CircularProgressBar component */}
      <CircularProgressBar progressColor="purple" />

      {/* Your fixed top bar (if you want both) */}
      {/* <motion.div
        className="fixed top-0 left-0 w-full h-2 bg-gradient-to-r from-purple-400 to-pink-400 z-50"
        style={{
          scaleX: useScroll().scrollYProgress, // Access scrollYProgress directly here if needed
          originX: 0
        }}
      /> */}
